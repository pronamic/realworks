...
return array(
	...
	Subtype::make('woning', './Wonen', array(
		...
		Subtype::make('kelder', './Verdiepingen/Kelder', array(
		...
		Subtype::make('beganeGrondOfFlat', './Verdiepingen/BeganeGrondOfFlat', array(
			Field::int('VerdiepingNr')->select('./VerdiepingNr'),
			Field::int('AantalKamers')->select('./AantalKamers'),
			Field::int('AantalSlaapkamers')->select('./AantalSlaapkamers'),
		)),
		Subtype::collection('verdieping', './Verdiepingen/Verdieping', array(
			Field::int('VerdiepingNr')->select('./VerdiepingNr'),
			Field::int('AantalKamers')->select('./AantalKamers'),
			Field::int('AantalSlaapkamers')->select('./AantalSlaapkamers'),
		)),
		Subtype::make('zolder', './Verdiepingen/Zolder', array(
			Field::int('VerdiepingNr')->select('./VerdiepingNr'),
			Field::int('AantalKamers')->select('./AantalKamers'),
			Field::int('AantalSlaapkamers')->select('./AantalSlaapkamers'),
		)),
		Subtype::make('vliering', './Verdiepingen/Vliering', array(
			Field::int('VerdiepingNr')->select('./VerdiepingNr'),
			Field::int('AantalKamers')->select('./AantalKamers'),
			Field::int('AantalSlaapkamers')->select('./AantalSlaapkamers'),
		)),
