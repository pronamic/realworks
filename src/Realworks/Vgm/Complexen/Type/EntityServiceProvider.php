...
use Realworks\Vgm\Complexen\Nummer\EntityServiceProvider as NummerServiceProvider;
use Realworks\Vgm\Complexen\Project\EntityServiceProvider as ProjectServiceProvider;
...
class EntityServiceProvider extends ServiceProvider
{
	...
	protected function registerFacade()
	{
		...
		if ( ! class_exists('Vgm\Type'))
		{
			class_alias('Realworks\Vgm\Complexen\Type\Facade', 'Vgm\Type');
		}
	}
	...
	protected function registerProviders()
	{
		...
		$this->instance->register(new ChildServiceProvider($this->instance, $this->app))->called('types');
