...
use JoostK\Illuminate\Http\JsonResponse;
use JoostK\Illuminate\Http\Response as IlluminateResponse;
...
class Response {
	 ...
	 * @param  int     $status
	 * @param  array   $headers
	 * @return \JoostK\Illuminate\Http\Response
	 */
	 ...
	 * @param  array  $headers
	 * @param  int    $options
	 * @return \JoostK\Illuminate\Http\JsonResponse
	 */
